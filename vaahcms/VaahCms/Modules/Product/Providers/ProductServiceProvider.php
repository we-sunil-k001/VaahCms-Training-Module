<?php namespace VaahCms\Modules\Product\Providers;


use Illuminate\Routing\Router;
use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use VaahCms\Modules\Product\Providers\RouteServiceProvider;
use VaahCms\Modules\Product\Providers\EventServiceProvider;
...
class ProductServiceProvider extends ServiceProvider
{
    ...
    {
        $viewPath = resource_path('/views/vaahcms/modules/product');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/views/vaahcms/modules/product';
    ...
    public function registerAssets()
    {
        ...
        $desPath = public_path('vaahcms/modules/product/assets');
    ...
    {
        $langPath = resource_path('/lang/vaahcms/modules/product');
