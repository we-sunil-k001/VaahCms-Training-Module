...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-product';
        ...
        */
        ...
        return view('product::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            ...
            'version' => config('settings.global.product_version')??config('product.version'),
            'is_dev' => config('product.is_dev'),
        ];
