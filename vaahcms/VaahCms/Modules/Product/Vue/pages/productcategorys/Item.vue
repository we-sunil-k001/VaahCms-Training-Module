            ...
            <template #icons>
                ...
                <div class="p-inputgroup">
                    ...
                    <Button label="Edit"
                            ...
                            data-testid="productcategorys-item-to-edit"
                            icon="pi pi-save"/>
                    ...
                    <Button
                        ...
                        data-testid="productcategorys-item-menu"
                    ...
                    <Button class="p-button-primary p-button-sm"
                            icon="pi pi-times"
                            data-testid="productcategorys-item-to-list"
                            @click="store.toList()"/>
                    ...
                    <div class="flex align-items-center justify-content-between">
                        ...
                        <div class="ml-3">
                            <Button label="Restore"
                                    class="p-button-sm"
                                    data-testid="productcategorys-item-restore"
