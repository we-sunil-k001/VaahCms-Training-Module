...
<html lang="en">
    <head>
        ...
        @if(env('THEME_MYTHEME_ENV') == 'develop')
            ...
            <link href="http://localhost:8080/mytheme/assets/css/style.css"
                  rel="stylesheet" media="screen">
        @else
            <link  href="{{vh_theme_assets_url("MyTheme", "css/build.css")}}"
                   rel="stylesheet" media="screen">
            <link  href="{{vh_theme_assets_url("MyTheme", "css/style.css")}}"
                rel="stylesheet" media="screen">
        @endif
        -->
